    ...
    <div class="container">
        <div class="row gap-y align-items-center">
            ...
            <div class="col-6 col-lg-3">
                <a href="/"><img src="{{URL::asset('img/logo-dark.png')}}" alt="logo"></a>
            </div>
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5d32198d1bcbff26"></script>
