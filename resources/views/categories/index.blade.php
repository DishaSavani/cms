...
@section('content')
  <div class="d-flex justify-content-end mb-2">
      <a  href="{{route('categories.create')}}" class="btn btn-success float-right" style="color: white">Add Category</a>
  </div>
              ...
              <form action="" method="POST" id="deleteCategoryForm">
                  ...
                  <div class="modal-content">
                      <div class="modal-header">
                          <h5 class="modal-title" id="deleteModelLable">Delete Category</h5>
