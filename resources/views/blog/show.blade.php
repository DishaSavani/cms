...
<header class="header text-white h-fullscreen pb-80" style="background-image: url({{URL::asset('storage/'.$post->image)}});" data-overlay="9">
    <div class="container text-center">
        ...
        <div class="row h-100">
            <div class="col-lg-8 mx-auto align-self-center">
                ...
                <p><img class="avatar avatar-sm" src="{{Gravatar::src(URL::asset('storage/'.$post->image) )}}" alt="..."></p>
            ...
            <hr>
                    ...
                    <script>
                        ...
                        (function() { // DON'T EDIT BELOW THIS LINE
                            ...
                            s.src = 'https://saas-blog-2zwwf1ezko.disqus.com/embed.js';
